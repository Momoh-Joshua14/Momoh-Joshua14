...
- ### ⚙️ My 2026 Tech Stack
-   **Frontend:** React, Next.js, Tailwind CSS, Figma
-   **AI Integratrion:** Gemini API, Vercel AI SDK, Prompt Engineering
-   **Backend & Logic:** Node.js, Python
-   **Tools:** Git, Cursor AI, Vercel
- ### 📚 Academic Focus (Westerfield College)
- **Computer Science (COS101):** Algorithmic Thinking
- **Mathematics (MTH101):** Advanced Logic & Calculus
...
---
📫 **Connect with me:** [LinkedIn]([https://www.linkedin.com/in/YOUR-PROFILE-URL](https://www.linkedin.com/in/momoh-joshua-7329a037b?utm_source=share_via&utm_content=profile&utm_medium=member_ios))
